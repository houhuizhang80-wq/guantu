...
export const PROJECT_DEFS: ProjectDef[] = [
  ...
  // ── 县处中局：给「等晋升」阶段可推进的目标 ──
  {
    id: 'laopian',
    name: '老旧小区改造攻坚',
    flavor: '管线、电梯、停车、物业，每一项都有人反对，也都有人等。',
    steps: 4,
    doneFx: { MX: 12, ZJ: 6, GX: 2 },
    minRank: 6,
    maxRank: 12,
    fromAction: 'xiachen',
  },
  {
    id: 'zhaoshang_xian',
    name: '产业链精准招商',
    flavor: '不是捡到篮里都是菜，要补链、延链、强链。',
    steps: 4,
    doneFx: { ZJ: 11, NL: 4, Risk: 3 },
    minRank: 6,
    maxRank: 13,
    fromAction: 'paotiao',
  },
  {
    id: 'shengtai',
    name: '河道与秸秆双线整治',
    flavor: '上面要水质，下面要出路。台账和现场都得硬。',
    steps: 3,
    doneFx: { MX: 6, Lian: 4, ZJ: 5, Risk: -4 },
    minRank: 6,
    maxRank: 12,
    fromAction: 'zicha',
  },
  {
    id: 'jiceng_zuzhi',
    name: '软弱涣散党组织整顿',
    flavor: '换人、立规、办实事——村看村，户看户，党员看支部。',
    steps: 3,
    doneFx: { ZJ: 7, MX: 5, GX: 3, NL: 2 },
    minRank: 7,
    maxRank: 12,
    fromAction: 'xiezuo',
  },
  {
    id: 'yingji_tixi',
    name: '基层应急体系补短板',
    flavor: '预案不能只挂在墙上，队伍和物资要能拉得出。',
    steps: 3,
    doneFx: { NL: 5, ZJ: 5, Risk: -6, MX: 3 },
    minRank: 6,
    maxRank: 12,
    fromAction: 'zicha',
  },
